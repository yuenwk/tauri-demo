// use tauri::{AppHandle, CustomMenuItem, Runtime, SystemTray, SystemTrayEvent, SystemTrayMenu, SystemTrayMenuItem, SystemTraySubmenu};
// use tauri::Manager;
//
//
...
//
// // 菜单事件
// pub fn handler<R: Runtime>(app: &AppHandle<R>, event: SystemTrayEvent) {
//
//     // 获取应用窗口
